...
paginas = ['https://www.gsuplementos.com.br/vitaminas/?pg=1', 'https://www.gsuplementos.com.br/vitaminas/?pg=2']
...
for pagina in paginas:
    requisicaoDePagina = requests.get(pagina, headers=headers)
